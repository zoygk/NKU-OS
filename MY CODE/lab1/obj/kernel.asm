...
void interrupt_handler(struct trapframe *tf) {
    ...
    8020043c:	b0850513          	addi	a0,a0,-1272 # 80200f40 <etext+0x524>
    80200440:	b905                	j	80200070 <cprintf>
            print_trapframe(tf);
    80200442:	b70d                	j	80200364 <print_trapframe>
                cprintf("100ticks\n");
    80200444:	00001517          	auipc	a0,0x1
    80200448:	aec50513          	addi	a0,a0,-1300 # 80200f30 <etext+0x514>
    8020044c:	c25ff0ef          	jal	ra,80200070 <cprintf>
                if(ticks / TICK_NUM == 10) sbi_shutdown();
    80200450:	601c                	ld	a5,0(s0)
    80200452:	06300713          	li	a4,99
    80200456:	c1878793          	addi	a5,a5,-1000
    8020045a:	fcf76be3          	bltu	a4,a5,80200430 <interrupt_handler+0x6c>
}
...
void exception_handler(struct trapframe *tf) {
    ...
    80200482:	10853583          	ld	a1,264(a0)
    80200486:	00001517          	auipc	a0,0x1
    8020048a:	b0a50513          	addi	a0,a0,-1270 # 80200f90 <etext+0x574>
    ...
    802004bc:	0141                	addi	sp,sp,16
            print_trapframe(tf);
    802004be:	b55d                	j	80200364 <print_trapframe>
            cprintf("ebreak caught at 0x%08x\n",tf->epc);
    802004c0:	10853583          	ld	a1,264(a0)
    802004c4:	00001517          	auipc	a0,0x1
    802004c8:	b1c50513          	addi	a0,a0,-1252 # 80200fe0 <etext+0x5c4>
...
static inline void trap_dispatch(struct trapframe *tf) {
    ...
    802004f6:	bf85                	j	80200466 <exception_handler>
        interrupt_handler(tf);
    802004f8:	b5f1                	j	802003c4 <interrupt_handler>
	...
...
printnum(void (*putch)(int, void*), void *putdat,
    ...
    802005f0:	a3478793          	addi	a5,a5,-1484 # 80201020 <etext+0x604>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    ...
    8020064c:	a0ca8a93          	addi	s5,s5,-1524 # 80201054 <etext+0x638>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
    ...
    80200654:	be0b8b93          	addi	s7,s7,-1056 # 80201230 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
    ...
    802008aa:	7aa60613          	addi	a2,a2,1962 # 80201050 <etext+0x634>
    ...
    802008bc:	78860613          	addi	a2,a2,1928 # 80201040 <etext+0x624>
    ...
    802008ce:	76e40413          	addi	s0,s0,1902 # 80201038 <etext+0x61c>
    ...
    80200958:	6e440413          	addi	s0,s0,1764 # 80201038 <etext+0x61c>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
    ...
    8020096e:	6cfa0a13          	addi	s4,s4,1743 # 80201039 <etext+0x61d>
...
00000000802009ba <sbi_set_timer>:
    ...
    802009c0:	65c73703          	ld	a4,1628(a4) # 80204018 <SBI_SET_TIMER>
